                ...
                <tbody>
                    <?php foreach ($materiales as $material): ?>
                        <tr>
                            ...
                            <!-- Enlaces de texto para editar y eliminar -->
                            <a href="#" onclick="editarMaterial('<?php echo $material['COD_MATERIAL']; ?>', '<?php echo $material['NOMBRE_MATERIAL']; ?>', '<?php echo $material['CONSECUTIVO_INICIAL']; ?>', '<?php echo $material['CONSECUTIVO_FINAL']; ?>', '<?php echo $material['CEDULA_TEC']; ?>', '<?php echo $material['NOMBRE_COMPLETO']; ?>', '<?php echo $material['TOTAL']; ?>', '<?php echo $material['OBSERVACION']; ?>'); return false;">
                                Editar
                            </a>
                            
                            <form method="POST" action="" style="display:inline;">
                                <input type="hidden" name="codMaterial" value="<?php echo htmlspecialchars($material['COD_MATERIAL']); ?>">
                                <a href="#" onclick="if(confirm('¿Estás seguro de eliminar este material?')) { this.closest('form').submit(); } return false;">
                                    Eliminar
                                </a>
                            </form>
