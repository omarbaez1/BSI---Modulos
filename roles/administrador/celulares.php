...
<head>
    ...
    <style>
        ...
        .toggle-button {
            background-color: #007acc; /* Color de fondo */
            color: white; /* Color del texto */
            padding: 12px 30px; /* Espaciado interno */
            border: none; /* Sin borde */
            border-radius: 50px; /* Bordes redondeados */
            font-size: 16px; /* Tamaño de fuente */
            cursor: pointer; /* Cursor pointer al pasar sobre el botón */
            box-shadow: 0 5px 15px rgba(0, 122, 204, 0.3); /* Sombra del botón */
        ...
        .toggle-button:hover {
            background-color: #005f99; /* Color de fondo al pasar el ratón */
            transform: translateY(-3px); /* Efecto de elevar el botón */
        }

        .toggle-button:active {
            background-color: #004a7a; /* Color de fondo al hacer clic */
            transform: translateY(1px); /* Efecto de hundir el botón */
        }
...
<button class="toggle-button" onclick="window.location.href='../../inicio_sesion/administrador.php';">Página Principal</button>
    ...
    <button class="toggle-button" onclick="toggleForm()">Añadir Nuevo Celular</button>
...
<div id="form-container" class="form-container">
    ...
    <form method="post">
        ...
        <input type="submit" name="add" value="Añadir Celular">
    </form>
</div>
<br>
    <!-- Listar celulares -->
        ...
        <tbody>
            <?php foreach ($celulares as $celular): ?>
                <tr>
                    ...
                    <td>
                        <a href="editar_celular.php?COD_CELULAR=<?php echo htmlspecialchars($celular['COD_CELULAR']); ?>">Editar</a>
                        <a href="?delete=<?php echo htmlspecialchars($celular['COD_CELULAR']); ?>" onclick="return confirm('¿Estás seguro de que quieres eliminar este registro?');">Eliminar</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
