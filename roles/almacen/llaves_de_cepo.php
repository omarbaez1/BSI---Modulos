        ...
        <div class="table-container">
            ...
            if (!empty($llaves)) {
                ...
                foreach ($llaves as $llave) {
                    ...
                    echo '<td>';
                    echo '<a href="editar_llave.php?codLlave=' . urlencode($llave['COD_LLAVE']) . '">Editar</a>  ';
                    echo '<a href="?codLlave=' . urlencode($llave['COD_LLAVE']) . '&eliminar=1" onclick="return confirm(\'¿Estás seguro de que quieres eliminar esta llave?\')">Eliminar</a>';
                    echo '</td>';
                    echo '</tr>';
                }
                echo '</tbody>';
