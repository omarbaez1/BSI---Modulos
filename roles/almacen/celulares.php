        ...
        <tbody>
            <?php foreach ($celulares as $celular): ?>
                <tr>
                    ...
                    <td>
                    <!-- Botón para editar -->
                    <a onclick="window.location.href='editar_celular.php?COD_CELULAR=<?php echo htmlspecialchars($celular['COD_CELULAR']); ?>'">
                        Editar
                    </a><br>
                    <br>
                    <!-- Enlace para eliminar con confirmación -->
                    <form method="POST" action="">
                        <input type="hidden" name="delete" value="<?php echo htmlspecialchars($celular['COD_CELULAR']); ?>">
                        <a href="#" onclick="if(confirm('¿Estás seguro de que quieres eliminar este registro?')) { this.closest('form').submit(); } return false;">
                            Eliminar
                        </a>
                    </form>
