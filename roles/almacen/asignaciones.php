            ...
            <?php if (!empty($asignaciones)): ?>
                <?php foreach ($asignaciones as $asignacion): ?>
                    <tr>
                        ...
                        <td>
                            <a href="?edit=<?php echo htmlspecialchars($asignacion['ID_ASIGNACION']); ?>">Editar</a>
                            <a href="?delete=<?php echo htmlspecialchars($asignacion['ID_ASIGNACION']); ?>" onclick="return confirmDelete()">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
