...
<div style="flex: 1; text-align: left;">
    ...
    <br>
    <br><button class="toggle-button" onclick="window.location.href='../../inicio_sesion/analista.php';">Página Principal</button><br>
                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach ($cambios as $cambio) : ?>
                            <tr>
                                <td><?= htmlspecialchars($cambio['ID_CAMBIO']) ?></td>
                            ...
                            <tr class="edit-form" data-id-cambio="<?= $cambio['ID_CAMBIO'] ?>" style="display: none;">
                                <td colspan="8">
                                    <form method="POST" action="">
                                        <input type="hidden" name="idCambioEditar" value="<?= htmlspecialchars($cambio['ID_CAMBIO']) ?>">
                                        <label for="cedulaTecEditar">Cédula Técnico:</label>
